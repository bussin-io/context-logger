export * from '@bussin/context-logger/core';
...
export { createLogger, logger } from '@bussin/context-logger/console';

// // to use winston implementation:
// export { createLogger, logger } from '@bussin/context-logger/winston';
